...
from extensions.reddit import AsyncCommentStream
...
class StreamWorker(Producer):
    ...
    def initialize_work(self):
        ...
        for topic in self.topics:
            jobs[0].append(AsyncCommentStream(self.reddit_auths[topic], topic, self.subreddits[topic], self.result_queue).stream())
