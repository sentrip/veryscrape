...
async def scrape_forever(scraper, start_delay, repeat_every,
                         scraper_args=(), scraper_kwargs=defaultdict(),
                         scrape_args=(), scrape_kwargs=defaultdict()):
    sc = scraper(*scraper_args, **scraper_kwargs)
    start = time.time()
    await asyncio.sleep(start_delay)
    await sc.scrape(*scrape_args, **scrape_kwargs)
